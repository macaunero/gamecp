...
function msg (options) {
    ...
    $(options.inputs).each(function (index, input) {
        var type = input.type;
        if (type=="img") {
            inputs += "<div class=\"msgInput\">" + "<a href=\"javascript:void(0);\" onclick=\"" + input.onclick + "\"><img id=\"" + input.id + "\" name=\"" + input.name + "\" src=\"" + input.src + "\" alt=\"captcha\" /></a>" + "<input class=\"" + (typeof input.class1 == "undefined" ? "" : input.class1) + "\" id=\"" + (typeof input.id1 == "undefined" ? "" : input.id1) + "\" type=\"" + input.type1 + "\" name=\"" + input.name1 + "\" value=\"" + (typeof input.value == "undefined" ? "" : input.value) + "\" placeholder=\"" + (typeof input.placeholder == "undefined" ? "" : input.placeholder) + "\" />" + "</div>" ;
